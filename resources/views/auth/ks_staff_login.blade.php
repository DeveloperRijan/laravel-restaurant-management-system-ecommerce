...
<html>
   <head>
      ...
      <title>{{env("APP_NAME")}} | Kitchen Staff Login</title>
      ...
      <div class="login-box">
         ...
         <div class="card">
            <div class="card-body login-card-body">
               <div class="card-body login-card-body">
                  <p class="login-box-msg"><i class="fa fa-user"></i> Kitchen Staff Signin</p>
                  @include("msg.msg")
                  <form action="{{route('ks.login.post')}}" method="post">
                     @csrf
                  ...
                  <p class="mb-1 text-center">
                     <a href="{{route('resetPassForm.get')}}?userType={{encrypt('KitchenStaff')}}">I forgot my password</a>
                  </p>
               </div>
            </div>
         </div>
