...
<form id="hidden__form" action="{{route('staff.credit-balance.store')}}" method="POST">
    @csrf
...
<div class="row" id="paypal--pay-option">
    ...
    <div class="col-lg-5 col-md-12">
        ...
        @if($paypalGateway && is_numeric(Request::get('amount')))
        ...
        @else
        <p class="text-info">SORRY - Payment gateway not configured yet!</p>
        @endif
    </div>
