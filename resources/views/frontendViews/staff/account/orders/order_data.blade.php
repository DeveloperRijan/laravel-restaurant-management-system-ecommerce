          ...
          @endforeach
              ...
              <tr class="special_tr">
                ...
                <td class="remove_borders text-center">
                  ...
                  <small>{{$data["checkout_summary"]['couponAppliedResponse']['coupon_discount_type']}} ({{env("CURRENCY_SYMBOL").$data["checkout_summary"]['couponAppliedResponse']['coupon_discount_amount']}})</small>
                  @else
              ...
              <tr class="special_tr">
                <td class="remove_borders" colspan="4" style="text-align: center;">
