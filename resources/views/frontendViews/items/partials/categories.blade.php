...
<script type="text/javascript">
  ...
  function filter_items_now(){
    ...
    console.log("/filter_items?q="+searchKey+"&min_price="+min_price+"&max_price="+max_price+"&category="+category+"&sort_by_popular="+sortByPopular+"&topFormSearchQuery="+topFormSearchQuery)
      
      $.ajax({
        url: "/filter_items?q="+searchKey+"&min_price="+min_price+"&max_price="+max_price+"&category="+category+"&sort_by_popular="+sortByPopular+"&topFormSearchQuery="+topFormSearchQuery,
        method: "GET",
        dataType: 'HTML',
        cache: false,
