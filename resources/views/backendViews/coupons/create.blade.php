    ...
    <div class="card-body">
      ...
      <form action="{{route('admin.coupons.store')}}" method="POST">
        ...
        <div class="form-group">
          ...
          <input type="text" placeholder="Code" name="coupon_code" maxlength="99" class="form-control" value="{{old('coupon_code')}}">
        </div>
          ...
          <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12">
              <div class="form-group">
                ...
                <input type="number" placeholder="Discount" name="coupon_discount" step="0.01" class="form-control" value="{{old('coupon_discount')}}">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
              <div class="form-group">
                ...
                <input placeholder="Number of coupon" type="number" name="number_of_coupon" class="form-control" min="1" value="{{old('number_of_coupon')}}">
