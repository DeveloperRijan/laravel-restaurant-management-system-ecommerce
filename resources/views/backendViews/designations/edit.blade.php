...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Update<small class="ml-3 mr-3">|</small><small>Designation</small></h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-plus mr-2"></i>Update</a>
        </li>
      </ul>
    </div>
    <div class="card-body">
      
      <form action="{{route('admin.designations.update', encrypt($data->id))}}" method="POST">
        @csrf
        @method("PUT")

        <div class="form-group">
          <label>* Title <small>(Should be Unique)</small></label>
          <input value="{{$data->title}}" type="text" placeholder="Title" name="title" maxlength="99" class="form-control">
        </div>
