  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        <li class="nav-item">
          <a class="nav-link active" href="{{route('admin.profile.get')}}"><i class="fa fa-user mr-2"></i>Profile</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{ route('admin.password.update.form') }}"><i class="fa fa-lock mr-2"></i>Password</a>
        </li>
      </ul>
    </div>
    <div class="card-body">
