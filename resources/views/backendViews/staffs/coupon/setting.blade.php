          ...
          <table class="table">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  @if($specialCoupon)
                  <input value="{{$specialCoupon->coupon_percent}}" name="special_coupon_percent" type="number" step="00.01" class="form-control">
                  @else
                  <input name="special_coupon_percent" type="number" step="00.01" class="form-control">
                  @endif
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  @if($generalCoupon)
                  <input value="{{$generalCoupon->coupon_percent}}" name="general_coupon_percent" type="number" step="00.01" class="form-control">
                  @else
                  <input name="general_coupon_percent" type="number" step="00.01" class="form-control">
                  @endif
                </td>
              </tr>
            </tbody>
