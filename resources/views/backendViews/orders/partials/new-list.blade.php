      ...
      <td>
        ...
        <div class="short-info">
          <div>
            ...
            <small>Payment Type : {{$order->payment_type}}</small> | 
            <small>{{$order->status}}</small>
          </div>
          @include("backendViews.orders.partials.shipping_address_list")
        </div>

        <div class="order-details">
          <h6 class="sub--heading">Order Details</h6>
          @include("backendViews.orders.partials.order_details_list")
        </div>
      </td>
