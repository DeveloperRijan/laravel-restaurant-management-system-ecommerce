            ...
            <tr role="row">
               ...
               <td>
                  <div class="btn-group btn-group-sm">
                     ...
                     <a class="text-success" onclick="return confirm('Are you sure to mark as Available?')" href="{{route('ks.product.action', [encrypt($product->id), encrypt('Available')])}}" class="btn btn-link">
                      <i class="fa fa-outdent"></i>
                     </a>
                     @else
                      <a class="text-warning" onclick="return confirm('Are you sure to mark as Sold Out?')" href="{{route('ks.product.action', [encrypt($product->id), encrypt('Sold Out')])}}" class="btn btn-link">
                        <i class="fa fa-outdent"></i>
                      </a>
                     @endif
