...
<body style="height: 100%; background-color: #f9f9f9;" class="hold-transition sidebar-mini primary">
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-light bg-white border-bottom">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{route('ks.dashboard')}}" class="nav-link">Dashboard</a>
                </li>
            </ul>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('orders*') ? 'active' : '' }}" href="{{route('ks.orders.index')}}?type=New">
                        <?php
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="{{route('ks.profile.get')}}" class="dropdown-item"> <i class="fa fa-user mr-2"></i> Profile </a>
        ...
        @include('ks_panel.layouts.sidebar')
