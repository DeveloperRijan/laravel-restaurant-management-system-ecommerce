...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Orders<small class="ml-3 mr-3">|</small><small>Management</small></h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
  ...
  <div class="card">
    <div class="card-header">
      ...
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100" style="justify-content: space-around">
        <li class="nav-item">
          <a class="nav-link @if($activeNav === 'New') active @endif" href="{{route('ks.orders.index')}}?type=New"><i class="fa fa-plus mr-2"></i>New</a>
        </li>
        <li class="nav-item">
          <a class="nav-link @if($activeNav === 'In Progress') active @endif" href="{{route('ks.orders.index')}}?type=In Progress"><i class="fa fa-undo mr-2"></i>In Progress</a>
        </li>
        <li class="nav-item">
          <a class="nav-link @if($activeNav === 'Out For Delivery') active @endif" href="{{route('ks.orders.index')}}?type=Out For Delivery"><i class="fa fa-truck mr-2"></i>Out For Delivery</a>
        </li>
        <li class="nav-item">
          <a class="nav-link @if($activeNav === 'Cancelled') active @endif" href="{{route('ks.orders.index')}}?type=Cancelled"><i class="fa fa-times mr-2"></i>Cancelled</a>
        </li>
        <li class="nav-item">
          <a class="nav-link @if($activeNav === 'Completed') active @endif" href="{{route('ks.orders.index')}}?type=Completed"><i class="fa fa-check mr-2"></i>Completed</a>
        </li>
        <li class="nav-item">
          <a class="nav-link @if($activeNav === 'index') active @endif" href="{{route('ks.orders.index')}}"><i class="fa fa-star mr-2"></i>All</a>
        </li>
      </ul>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        <table class="table dataTable" width="100%" style="width: 100%;">
         <tbody id="render__data">
          @include("ks_panel.orders.partials.new-list")
         </tbody>
        </table>

        <input type="hidden" id="hidden__action_url" value="{{ route('ks.ordersDatatableCustom.data') }}">
